...
// @version      1.1.2
// @description  practice temporial/spatial stack for various tanks (diep.io)
// @author       GLM-5.1
// @license      GPLv2
// @match        https://diep.io/*
// @match        https://*.4v4.lol/*
  ...
  const SEQUENCES = [
    ...
    },
    {
      ...
      inputs: [
        ...
        { time: 0.480, angle: 180, direction: 'ccw' },
        { time: 0.560 },
        { time: 0.640, angle: 0, direction: 'cw' },
        { time: 0.800, angle: 180, direction: 'ccw' },
        { time: 0.960, angle: 0, direction: 'cw' },
        { time: 1.120, angle: 180, direction: 'ccw' },
        { time: 1.280, angle: 0, direction: 'cw' },
        { time: 1.440, angle: 180, direction: 'ccw' },
        { time: 1.600, angle: 0, direction: 'cw' },
        { time: 1.760, angle: 180, direction: 'ccw' },
        { time: 1.920, angle: 0, direction: 'cw' },
        { time: 2.080, angle: 180, direction: 'ccw' },
        { time: 2.240, angle: 0, direction: 'cw' },
        { time: 2.400, angle: 180, direction: 'ccw' },
        { time: 2.560, angle: 0, direction: 'cw' },
        { time: 2.720, angle: 180, direction: 'ccw' },
        { time: 2.880, angle: 0, direction: 'cw' },
      ],
    },
    {
      name: 'gt eco flip',
    ...
    {
      name: 'spread stack (cw)',
      inputs: [
        { time: 0.000 },
        { time: 0.040, releaseEnd: 0.480 },
        { time: 0.540 },//between 0.52 and 0.56
        { time: 0.640, angle: 0, direction: 'cw' },
        { time: 0.660, angle: 15, direction: 'cw' },
        { time: 0.780, angle: 30, direction: 'cw' },
        { time: 0.860, angle: 45, direction: 'cw' },
        { time: 0.980, angle: 60, direction: 'cw' },
        { time: 1.100, angle: 75, direction: 'cw' },
        { time: 1.280, angle: 0, direction: 'cw' },
        { time: 1.300, angle: 15, direction: 'cw' },
        { time: 1.420, angle: 30, direction: 'cw' },
        { time: 1.500, angle: 45, direction: 'cw' },
        { time: 1.620, angle: 60, direction: 'cw' },
        { time: 1.740, angle: 75, direction: 'cw' },
        { time: 1.920, angle: 0, direction: 'cw' },
        { time: 1.940, angle: 15, direction: 'cw' },
        { time: 2.060, angle: 30, direction: 'cw' },
        { time: 2.140, angle: 45, direction: 'cw' },
        { time: 2.260, angle: 60, direction: 'cw' },
        { time: 2.380, angle: 75, direction: 'cw' },
      ],
    },
    {
      name: 'spread stack (ccw)',
      inputs: [
        { time: 0.000 },
      { time: 0.040, releaseEnd: 0.480 },
      { time: 0.540 },//between 0.52 and 0.56
      { time: 0.640, angle: 0, direction: 'ccw' },
      { time: 0.660, angle: 15, direction: 'ccw' },
      { time: 0.780, angle: 30, direction: 'ccw' },
      { time: 0.860, angle: 45, direction: 'ccw' },
      { time: 0.980, angle: 60, direction: 'ccw' },
      { time: 1.100, angle: 75, direction: 'ccw' },
      { time: 1.280, angle: 0, direction: 'ccw' },
      { time: 1.300, angle: 15, direction: 'ccw' },
      { time: 1.420, angle: 30, direction: 'ccw' },
      { time: 1.500, angle: 45, direction: 'ccw' },
      { time: 1.620, angle: 60, direction: 'ccw' },
      { time: 1.740, angle: 75, direction: 'ccw' },
      { time: 1.920, angle: 0, direction: 'ccw' },
      { time: 1.940, angle: 15, direction: 'ccw' },
      { time: 2.060, angle: 30, direction: 'ccw' },
      { time: 2.140, angle: 45, direction: 'ccw' },
      { time: 2.260, angle: 60, direction: 'ccw' },
      { time: 2.380, angle: 75, direction: 'ccw' },
      ],
    },
    {
      name: 'spread stack (alter)',//lao put this in, not me
      inputs: [
        { time: 0.000 },
      { time: 0.040, releaseEnd: 0.480 },
      { time: 0.540 },//between 0.52 and 0.56
      ...
      { time: 2.260, angle: 60, direction: 'cw' },
      { time: 2.380, angle: 75, direction: 'cw' },
      { time: 2.560, angle: 0, direction: 'ccw' },
      { time: 2.580, angle: 15, direction: 'ccw' },
      { time: 2.700, angle: 30, direction: 'ccw' },
      { time: 2.780, angle: 45, direction: 'ccw' },
      { time: 2.900, angle: 60, direction: 'ccw' },
      { time: 3.020, angle: 75, direction: 'ccw' },
      ],
    },
    {
      name: 'flipfire (cw)',
      inputs: [
        { time: 0.000 },
        { time: 0.160, angle: 150, direction: 'cw' },
        { time: 0.320, angle: 0, direction: 'ccw' },
        { time: 0.480, angle: 150, direction: 'cw' },
        { time: 0.640, angle: 0, direction: 'ccw' },
        { time: 0.800, angle: 150, direction: 'cw' },
        { time: 0.960, angle: 0, direction: 'ccw' },
        { time: 1.120, angle: 150, direction: 'cw' },
        { time: 1.280, angle: 0, direction: 'ccw' },
        { time: 1.440, angle: 150, direction: 'cw' },
        { time: 1.600, angle: 0, direction: 'ccw' },
        { time: 1.760, angle: 150, direction: 'cw' },
        { time: 1.920, angle: 0, direction: 'ccw' },
        { time: 2.080, angle: 150, direction: 'cw' },
        { time: 2.240, angle: 0, direction: 'ccw' },
        { time: 2.400, angle: 150, direction: 'cw' },
        { time: 2.560, angle: 0, direction: 'ccw' },
      ],
    },
    {
      ...
      inputs: [
        { time: 0.000 },
        { time: 0.160, angle: 150, direction: 'ccw' },
        { time: 0.320, angle: 0, direction: 'cw' },
        { time: 0.480, angle: 150, direction: 'ccw' },
        { time: 0.640, angle: 0, direction: 'cw' },
        { time: 0.800, angle: 150, direction: 'ccw' },
        { time: 0.960, angle: 0, direction: 'cw' },
        { time: 1.120, angle: 150, direction: 'ccw' },
        { time: 1.280, angle: 0, direction: 'cw' },
        { time: 1.440, angle: 150, direction: 'ccw' },
        { time: 1.600, angle: 0, direction: 'cw' },
        { time: 1.760, angle: 150, direction: 'ccw' },
        { time: 1.920, angle: 0, direction: 'cw' },
        { time: 2.080, angle: 150, direction: 'ccw' },
        { time: 2.240, angle: 0, direction: 'cw' },
        { time: 2.400, angle: 150, direction: 'ccw' },
        { time: 2.560, angle: 0, direction: 'cw' },
      ],
    },
    {
      ...
      inputs: [
        ...
        { time: 0.26 },
        { time: 0.32, angle: 0, direction: 'ccw' },
        { time: 0.38, angle: 22.5, direction: 'cw' },
        { time: 0.50, angle: 45, direction: 'cw' },
        { time: 0.64, angle: 0, direction: 'ccw' },
        { time: 0.70, angle: 22.5, direction: 'cw' },
        { time: 0.82, angle: 45, direction: 'cw' },
        { time: 0.96, angle: 0, direction: 'ccw' },
        { time: 1.02, angle: 22.5, direction: 'cw' },
        { time: 1.14, angle: 45, direction: 'cw' },
      ],
    },
    {
      name: 'penta (ccw)',
      inputs: [
        ...
        { time: 0.04, releaseEnd: 0.08 },
        { time: 0.26 },
        { time: 0.32, angle: 0, direction: 'cw' },
        { time: 0.38, angle: 22.5, direction: 'ccw' },
        { time: 0.50, angle: 45, direction: 'ccw' },
        { time: 0.64, angle: 0, direction: 'cw' },
        { time: 0.70, angle: 22.5, direction: 'ccw' },
        { time: 0.82, angle: 45, direction: 'ccw' },
        { time: 0.96, angle: 0, direction: 'cw' },
        { time: 1.02, angle: 22.5, direction: 'ccw' },
        { time: 1.14, angle: 45, direction: 'ccw' },
      ],
    },
  ];
 ...
 menuActive:      'rgba(0, 229, 204, 0.3)',
  ...
  function buildInputList() {
    ...
    processedInputs.forEach((inp, i) => {
      ...
      let label = '';
      if (inp.hasAngle) {
        const dir = inp.direction === 'cw' ? 'CW' : 'CCW';
  ...
  function startRecording() {
    ...
    // Compute _effectiveAngle for every angle input (relative to first polar angle)
  ...
  function processPassedAngles() {
    ...
    while (currentAngleIndex < angleInputs.length) {
      ...
      if (elapsed >= aInp.time) {
        ...
        const userAngle = getUserAngle();
        let diff = userAngle - aInp._effectiveAngle;
        ...
        completedArcs.push({
          fromAngle: aInp._effectiveAngle,
          toAngle: userAngle,
          color: color,
          radius: arcRadius,
        });
 ...
 cursorY: cursorPosition.y,
  ...
  function updateNextRequiredAngle() {
    ...
    if (currentAngleIndex < angleInputs.length) {
      nextRequiredAngle = angleInputs[currentAngleIndex]._effectiveAngle;
    } else {
